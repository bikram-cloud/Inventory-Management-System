	...
	public function createUserAccount($username,$email,$password,$usertype){
		...
		if ($this->emailExists($email)) {
			...
			$pre_stmt = $this->con->prepare("INSERT INTO `user`(`username`, `email`, `password`, `usertype`, `register_date`, `last_login`, `notes`)
			 VALUES (?,?,?,?,?,?,?)");
			$pre_stmt->bind_param("sssssss",$username,$email,$pass_hash,$usertype,$date,$notes);
...
//$user = new User();
//echo $user->createUserAccount("Test","bikramnp43@gmail.com","1234567890","Admin");

//echo $user->userLogin("bikramnp43@gmail.com","1234567890");
